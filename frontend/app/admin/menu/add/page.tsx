...
export default function AddMenuItemPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Add Menu Item</h1>
        <p className="text-slate-600 mt-2">Create a new menu item for your restaurant</p>
      </div>
      ...
      <Card className="max-w-3xl">
        <CardHeader>
          ...
          <CardDescription>
            Enter the menu item details below. All fields marked with * are required.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <MenuItemForm
